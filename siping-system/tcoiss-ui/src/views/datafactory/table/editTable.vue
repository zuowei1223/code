    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="字段信息" name="cloum">
        <el-table ref="dragTable" :data="cloumns" row-key="columnId" :max-height="tableHeight">
          ...
          <el-table-column label="数据模型" min-width="10%">
            <template slot-scope="scope">
              <el-input v-model="scope.row.dataModel"></el-input>
            </template>
          </el-table-column>
          ...
          <el-table-column label="过滤" min-width="5%">
            <template slot-scope="scope">
              <el-checkbox true-label="1" v-model="scope.row.isFilter"></el-checkbox>
            </template>
          </el-table-column>
          <!--<el-table-column label="排序" min-width="5%">
            <template slot-scope="scope">
              <el-checkbox true-label="1" v-model="scope.row.sort"></el-checkbox>
            </template>
          </el-table-column>-->
...
<script>
import { getBusTable, updateBusTable } from "@/api/datafactory/table";
